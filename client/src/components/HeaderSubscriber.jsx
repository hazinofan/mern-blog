...
function HeaderSubscriber() {
  return (
    <div>
        <div class="flex mb-14 justify-center items-center dark:bg-slate-800">
    <div class="mx-auto mt-10 flex justify-center px-4 sm:mt-12 sm:px-6 md:mt-16 lg:mt-20 lg:px-8">
        <div class="text-center ">
            <h1
                ...
                <span class="block xl:inline"><span class="mb-1 block">Enjoy Your Time </span>
                <span class="bg-gradient-to-r from-indigo-400 to-pink-600 bg-clip-text text-transparent">
                    Surfing Your Posts and Comments
                </span>
                </span>
                <div class="mt-2">As a member Of
                    <span class=" ml-3 relative mt-3 whitespace-nowrap text-blue-600"><svg aria-hidden="true" viewBox="0 0 418 42"
                    ...
                    <span class="relative">POSTIFY</span>
                    </span>
                </div>
            </h1>
            <p class="mx-auto mt-3 max-w-xl text-lg text-gray-500 dark:text-slate-400 sm:mt-5 md:mt-5">
              Dive into your personalized feed on POSTIFY, where you can easily edit or delete your Comments, posts..
            </p>
        </div>
    </div>
</div>
