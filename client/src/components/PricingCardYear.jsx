...
function PricingCardYear() {
  ...
  return (
        ...
        <h1 className='text-3xl font-bold lg:text-xl italic uppercase sm:text-xs'>Postify Annual Plan</h1>
        </div>
            ...
            <div>
                <div className="relative flex justify-around">
                    <div className="flex items-end">
                        <span className="text-8xl text-gray-800 font-bold leading-0">4.99</span>
                        <div className="pb-2">
...
export default PricingCardYear;
