  ...
  return (
    <div className='min-h-screen mt-20'>
      <Helmet>
        ...
        <meta name="description" content="Sign in to POSTIFY to discover and share rich blog content. Join our community and start contributing today." />
        <meta name="keywords" content="blog, sign in, login, POSTIFY, blogging, articles, community" />
      </Helmet>
      <div className="flex p-3 max-w-3xl mx-auto flex-col md:flex-row md:items-center gap-10">
        <div className="flex-1 text-center sm:text-left">
          <Link className='self-center whitespace-nowrap text-sm:text-xl font-semibold dark:text-white'>
            <img className="w-80 mb-10" src={Signin} alt="logo" />
          </Link>
