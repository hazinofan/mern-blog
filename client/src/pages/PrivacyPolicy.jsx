...
function PrivacyPolicy() {
    return (
        <div className="bg-gray-100 dark:bg-gray-900">
            ...
            <h1
                class="text-4xl font-extrabold tracking-tight text-gray-900 dark:text-slate-200 sm:text-5xl md:text-6xl mb-10">
                ...
                <h2 className="text-2xl font-bold mb-2 underline text-red-500">Information We Collect</h2>
                ...
                <h2 className="text-2xl font-bold mb-2 underline text-red-500">How We Use the Information</h2>
                ...
                <ul className="list-disc list-inside mb-4">
                    ...
                    <li>Sending promotional emails about new products, special offers, or other information which we think you may
                        find
                        interesting</li>
                ...
                <h2 className="text-2xl font-bold mb-2 underline text-red-500">Security</h2>
                ...
                <h2 className="text-2xl font-bold mb-2 underline text-red-500">Cookies</h2>
                ...
                <h2 className="text-2xl font-bold mb-2 underline text-red-500">Links to Other Websites</h2>
                ...
                <h2 className="text-2xl font-bold mb-2 underline text-red-500">Controlling Your Personal Information</h2>
                ...
                <ul className="list-disc list-inside mb-4">
                    <li>If you have previously agreed to us using your personal information for direct marketing purposes, you may
                        change your mind at any time by writing to or emailing us at <a href="mailto:info@example.com">info@example.com</a></li>
